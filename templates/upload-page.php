 ...
 * `require`d straight into the global scope by core's template loader (see
 * filter_template_include() in inc/functions.php), and namespacing doesn't
 * protect PHP variables the way it does functions and classes.
 *
 * @return void
 */
